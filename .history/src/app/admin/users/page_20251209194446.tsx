          ...
          <div className="px-6 py-4 bg-gray-800 border-b border-gray-900">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 pl-10 pr-4 border border-gray-00 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
              />
              <svg 
