          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-neutral-800 border-bold border-gray-200">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-bold text-gray- uppercase tracking-wider">
                    Email
                  </th>
                  <th className="px-6 py-3 text-left text-xs font-bold text-gray- uppercase tracking-wider">
                    Nombre
                  ...
                  <th className="px-6 py-3 text-right text-xs font-bold text-gray- uppercase tracking-wider">
                    Acción
                  </th>
                </tr>
              </thead>
