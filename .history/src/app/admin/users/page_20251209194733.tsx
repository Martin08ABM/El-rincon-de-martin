    ...
    <div className="min-h-screen bg-black p-8">
      <div className="max-w-7xl mx-auto">
        <div className="bg-neutral-800 rounded-lg shadow-md overflow-hidden">
          ...
          {/* 🔍 BARRA DE BÚSQUEDA */}
          <div className="px-6 py-4 bg-gray-800 border-b border-gray-900">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-neutral-800 border-b border-gray-200">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-b text-gray-500 uppercase tracking-wider">
                    Email
                  </th>
                  <th className="px-6 py-3 text-left text-xs font-b text-gray-500 uppercase tracking-wider">
                    Nombre
                  ...
                  <th className="px-6 py-3 text-right text-xs font-b text-gray-500 uppercase tracking-wider">
                    Accion
                  </th>
                </tr>
              </thead>
                  ...
                  filteredUsers.map((user) => (
                    ...
                    >
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-b text-gray-900">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-b">
                        <div className="flex gap-2 justify-end">
                          {user.banned ? (
                            <button
                              onClick={() => doAction(user.id, 'unban')}
                              disabled={actionLoading === user.id}
                              className="px-3 py-1.5 bg-green-600 text-white rounded hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-xs font-b"
                            >
                            ...
                            <button
                              ...
                              disabled={actionLoading === user.id}
                              className="px-3 py-1.5 bg-yellow-600 text-white rounded hover:bg-yellow-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-xs font-b"
                            >
