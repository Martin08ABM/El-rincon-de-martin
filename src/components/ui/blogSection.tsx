    ...
    <div className="flex flex-col text-left mt-10 ml-4 md:ml-[50px] w-[90%] md:w-[80%]">
      ...
      <div className="flex flex-row left-0 relative mt-4 ml-2 md:ml-6 overflow-x-auto">
        <ul className="flex flex-row gap-3 md:gap-4">
          {posts?.map((post) => (
            <li key={post.id} className="min-w-[280px] md:max-w-[300px] max-h-[100px] shrink-0 overflow-hidden border-2 border-neutral-600 rounded-lg px-3 md:px-4 py-2 bg-neutral-800 hover:bg-neutral-700/40 transition-all duration-200">
